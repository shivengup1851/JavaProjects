    ...
    public static Product getProduct(String productCode)
    {
           ...
           productCode.equalsIgnoreCase("mcb2"))
        {
            ...
            if (productCode.equalsIgnoreCase("java"))
            {
                ...
                b.setDescription("Webb's Beginning Java");
                b.setPrice(49.50);
                b.setAuthor("Mighty Mouse");
            }
            else if (productCode.equalsIgnoreCase("jsps"))
            {
                b.setCode(productCode);
                b.setDescription("Webb's Java Servlets and JSP");
                b.setPrice(49.50);
                b.setAuthor("Oscar the Grouch");
            }
            else if (productCode.equalsIgnoreCase("mcb2"))
            {
                b.setCode(productCode);
                b.setDescription("Webb's Mainframe COBOL");
                b.setPrice(59.50);
                b.setAuthor("Elmo");
            }
